...
# Modify 'title_output' and you'll also need to mannually mkdir of the title_output in respective 'figures' folder
# You can change which input are used to put into the model by changing the file dictionaries.
# JULES data only runs from July 2000 to Dec 2010, so I created a separate dictionary for that (below). If you use this, you'll
# also have to change the output and figure directory
...
# The jul2000-2014 files have 168 time points and start at July 2000 and go up to June 2014, like the obs files. This
# makes them compatible when mixing up obs + UKESM runs
